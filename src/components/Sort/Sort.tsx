...
export const Sort = ({ sortType, onClickSort }: any) => {
  const [open, setOpen] = useState(false);

  const list = [
    { name: 'высокий рейтинг', sortProperty: 'rating' },
    { name: 'низкий рейтинг', sortProperty: '-rating' },
